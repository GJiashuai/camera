...
public class CameraFeatures {
  ...
  private static final String LENS_FOCUS_DISTANCE = "LENS_FOCUS_DISTANCE";
  ...
  public static CameraFeatures init(
    ...
    cameraFeatures.setFocusModeLockedWithLensPosition(cameraFeatureFactory.createFocusModeLockedWithLensPositionFeature(cameraProperties));
   ...
   */
  @NonNull
  public FocusModeLockedWithLensPositionFeature getFocusModeLockedWithLensPosition() {
    return (FocusModeLockedWithLensPositionFeature) Objects.requireNonNull(featureMap.get(LENS_FOCUS_DISTANCE));
  }
   ...
   * @param zoomLevel the {@link ZoomLevelFeature} instance to set.
   */
  public void setFocusModeLockedWithLensPosition(@NonNull FocusModeLockedWithLensPositionFeature lensPosition) {
    this.featureMap.put(LENS_FOCUS_DISTANCE, lensPosition);
  }
}