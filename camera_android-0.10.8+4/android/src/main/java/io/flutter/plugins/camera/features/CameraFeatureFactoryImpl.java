...
public class CameraFeatureFactoryImpl implements CameraFeatureFactory {
  ...
  @NonNull
  @Override
  public FocusModeLockedWithLensPositionFeature createFocusModeLockedWithLensPositionFeature(
      @NonNull CameraProperties cameraProperties) {
    return new FocusModeLockedWithLensPositionFeature(cameraProperties);
  }
